                    ...
                    <div key={p.id} className="rounded-2xl border border-slate-200 bg-white shadow-sm">
                      <div className="p-4">
                        <div className="flex items-start justify-between gap-3">
                          <div>
                            ...
                            <div className="mt-0.5 text-xs text-slate-500">{p.category} • {formatProductId(p.id)}</div>
                          </div>
                          <div className="flex flex-col items-end gap-1">
                             <div className="text-sm font-semibold text-slate-900">Q{Number(p.price).toFixed(2)}</div>
                             <button 
                        ...
                        <div className="mt-3 flex items-center justify-between">
                          ...
                          <div className="text-xs font-semibold text-slate-900">{p.stock}</div>
                        </div>
                      </div>
                      <div className="border-t border-slate-200 p-3 grid grid-cols-2 gap-2">
                        <button
                          ...
                          className="flex items-center justify-center gap-2 rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50"
                        >
                          Copiar
                        </button>
                         <button
                           ...
                           className="flex items-center justify-center gap-2 rounded-xl bg-[#0B1F3A] px-3 py-2 text-sm font-medium text-white hover:bg-[#0A1A31] transition-colors"
                         >
